...
import './Header.css';
import Avatar from '../../icons/Avatar face.png'
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                {loggedInUser.isSignIn ? <p className='username'>{loggedInUser.name} <img src={Avatar}/></p> : <p><Link className="nav-link active" to="/login">Login</Link></p>}
                            </li>
                        </ul>
                    </div>
